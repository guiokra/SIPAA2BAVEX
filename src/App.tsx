...
const SUGESTOES_MITIGACAO = {
  "RECURSOS HUMANOS": [
    "Um dos pilotos realizou pelo menos um voo nos últimos 30 dias — NÃO: a) Na primeira etapa do voo, executar perfil conservador, com callouts de velocidade, altura, potência e razão de descida, evitando manobras não essenciais até a tripulação estar estabilizada.",
    "IP/PO com menos de 50 HV no modelo na função de 1P: a) Antes das fases críticas, o 1P verbalizará sua intenção de manobra e o 2P confirmará parâmetros, trajetória e limites de abortagem.",
    "PA/PB com menos de 50 HV no modelo na função de 2P: a) O 2P auxiliará o 1P no monitoramento de velocidade, altitude, potência, navegação, fonia e identificação de desvios.",
    "MVO/MVI com menos de 50 HV no modelo na função de MVO/MVI: a) O MV verbalizará obstáculos, distância, tendência de deslocamento e condição para prosseguir ou interromper a manobra.",
    "MVA/MVB com menos de 50 HV no modelo na função de MVA/MVB: a) O MV repetirá os comandos recebidos e informará “livre”, “obstáculo”, “aproxima”, “afasta” ou “abortar” de forma padronizada.",
    "Tripulação sem CRM nos últimos 24 meses: a) Estabelecer no briefing que qualquer tripulante pode comandar “aborta”, “arremete” ou “corrige” diante de risco imediato.",
    "Briefing da missão incompleto: a) Antes da partida, confirmar verbalmente rota, combustível, meteorologia, alternativa, funções da tripulação e critério de abortagem.",
    "Briefing de segurança incompleto: a) Antes da atividade, confirmar com os envolvidos área segura, área proibida, sinais/comunicação e conduta em emergência.",
  ],
  METEOROLOGIA: [
    "Local de pouso/decolagem não reconhecido ou não homologado: a) Realizar passagem de reconhecimento antes do pouso e só prosseguir após identificar obstáculos, vento, área de escape e ponto de arremetida.",
    "Aglomeração de pássaros na região de voo: a) Reduzir permanência em baixa altura, aumentar vigilância externa e arremeter se houver concentração de aves na trajetória.",
    "Informações necessárias ao voo indisponíveis: a) Listar no briefing quais informações estão incertas e definir o que impedirá a decolagem ou o prosseguimento.",
    "Publicações técnicas desatualizadas ou indisponíveis: a) Não usar informação duvidosa para decisão crítica; confirmar por fonte atualizada antes da execução.",
    "Previsão de tempo significativo em rota: a) Definir antes da decolagem ponto de retorno, rota de desvio e meteorologia mínima para continuar.",
    "Infraestrutura de apoio incerta: a) Confirmar antes do pouso se há comunicação, segurança da área e apoio previsto; se não houver, executar alternativa planejada.",
  ],
  MATERIAL: [
    "Aeronave com menos de 10 HV após inspeção A/TC: a) Durante giro, decolagem e primeiros minutos, monitorar parâmetros e interromper o voo diante de luz, ruído, vibração ou indicação anormal.",
    "Aeronave em condições de executar pairado fora do efeito solo no local de pouso: a) Antes da aproximação, confirmar torque/potência disponível, peso estimado e margem para arremetida.",
    "Aeronave já pré-voada: a) Antes da partida, a tripulação reconferirá visualmente combustível, tampas, travamentos, vazamentos, pás, entradas de ar e itens críticos externos.",
  ],
  MISSÃO: [
    "Tempo inadequado para planejamento e preparação: a) Antes da partida, confirmar os itens críticos: rota, meteorologia, combustível, alternativa, performance e abortagem; se algum não estiver claro, não decolar.",
    "Voo com duração superior a 3 HV contínuas: a) Definir ponto de reavaliação de fadiga e alternância de tarefas entre PF/PM durante o voo.",
    "Operação com duração superior a 5 dias: a) No briefing diário, cada tripulante informará sua condição de fadiga, sono e atenção antes de assumir a missão.",
    "Mais de 05 repetições da mesma manobra: a) Executar séries curtas, pausar para reavaliar desempenho e interromper se houver queda de atenção ou padronização.",
    "Voo com autoridade de bordo: a) Antes da decolagem, o comandante informará que mínimos, rota, pouso e continuidade da missão serão decisões técnicas da tripulação.",
    "Tempo insuficiente para cumprimento da missão com imprevistos: a) Definir horário-limite para retornar, alternar, reduzir objetivo ou cancelar a missão.",
    "MV não embarcado no voo: a) Os pilotos dividirão setores de vigilância externa e não executarão manobras que dependam de observação traseira/lateral não disponível.",
  ],
  ORGANIZAÇÃO: [
    "Pressões externas para execução da missão: a) Registrar no briefing que pressão operacional não altera mínimos, limitações, meteorologia mínima ou critério de abortagem.",
    "Tripulação sem padronização recente de manobras e procedimentos da U.A.: a) Antes da execução, revisar fonia, callouts, sequência da manobra, responsabilidades e comando de abortagem.",
    "Baixa participação em reuniões de Segurança de Voo da OM: a) Relembrar no briefing uma ocorrência ou alerta recente aplicável à missão e a conduta preventiva correspondente.",
    "Tripulação e/ou Fração de Helicópteros de U.A. diferente: a) Padronizar antes do voo os termos de fonia, sinais, funções, sequência da manobra e comando de interrupção.",
  ],
  IFR: [
    "Voo acima de 10.000 ft: a) Definir tempo máximo acima de 10.000 ft, monitorar sintomas de hipóxia e descer se houver suspeita.",
    "Nivelamento abaixo dos obstáculos previstos na rota: a) Antes da decolagem, definir altitude mínima por trecho e conferir no voo antes de cada mudança de nível.",
    "Briefing meteorológico não realizado por especialista: a) A tripulação revisará teto, visibilidade, vento, formações, gelo, alternativa e tendência antes da partida.",
    "Piloto sem voo IFR nos últimos 30 dias: a) Utilizar callouts obrigatórios de altitude, proa, razão, aproximação dos mínimos e desvios de parâmetros.",
    "DEP a partir de aeródromo não homologado IFR: a) Definir trajetória inicial, obstáculos críticos, altitude mínima de segurança e ponto para retornar ou cancelar o prosseguimento.",
  ],
  TÉCNICO: [
    "Primeiro giro e/ou voo após inspeção: a) Executar giro e decolagem com perfil conservador, mantendo monitoramento cruzado de parâmetros e retorno imediato em caso de anormalidade.",
    "Primeiro voo após troca de componentes vitais: a) Identificar o componente trocado e definir quais indicações, ruídos, vibrações ou parâmetros serão monitorados.",
    "Autonomia mínima de 40 minutos: a) Definir combustível mínimo para retorno/alternativa e ponto de decisão antes do consumo da reserva.",
    "OS afetas às intervenções não verificadas ou não fechadas: a) Antes da partida, confirmar com a manutenção a situação das OS, serviços executados, pendências e liberação da aeronave.",
    "Quebra na sequência dos serviços de manutenção: a) Confirmar quais serviços foram interrompidos e quais itens foram reconferidos antes da liberação.",
  ],
  INSTRUÇÃO: [
    "Haverá hot-seat: a) Antes da troca, estabilizar a aeronave e confirmar verbalmente a transferência dos comandos com “tá contigo” e “tá comigo”.",
    "Voo com piloto aluno ou piloto em formação IFR/OVN: a) Definir antes do voo quais fases o aluno executará e quais desvios obrigam intervenção imediata do instrutor.",
    "Voo de emergência simulada, IFR ou OVN: a) Definir altura mínima, velocidade mínima, potência/configuração limite e comando para encerrar a simulação.",
    "Primeiro voo de Habilitação Técnica de tripulante no modelo: a) Antes de cada fase nova, o instrutor explicará a manobra, demonstrará se necessário e assumirá diante de desvio inseguro.",
  ],
  OVN: [
    "Voo em noite nível 4 ou 5: a) Definir altura/altitude mínima, referências visuais esperadas e conduta em caso de perda de referência.",
    "Voo em área urbana: a) Dividir setores de vigilância e reforçar chamada obrigatória de fios, torres, obstáculos, tráfego e áreas de pouso.",
    "Reconhecimento fora das áreas de instrução da Av Ex: a) Antes da entrada na área, revisar carta/imagem, obstáculos, iluminação, rota de entrada, rota de saída e área de escape.",
    "Dispositivo de iluminação individual incompatível com o voo OVN: a) Conferir todas as luzes antes do voo e retirar ou ajustar qualquer equipamento que prejudique os óculos.",
    "Presença de neblina e/ou precipitação: a) Definir antes da decolagem o critério para desviar, subir, retornar ou interromper a missão.",
    "Mais de 30 dias sem voar OVN: a) Antes da fase crítica, revisar referências visuais, setores de varredura, critérios de perda de referência e callouts obrigatórios de altura, deriva, velocidade e obstáculos.",
  ],
};
